...
# Ajouter batch granuality, closed, tester history
...
class WandBLoggerTest(TestCase):
    ...
    def test_with_run_init(self):
        with patch("poutyne.framework.wandb_logger.wandb") as wandb_patch:
            ...
            wandb_patch.assert_not_called()
            self.assertIsInstance(wandb_logger.wandb_logger, wandb.sdk.wandb_run.Run)
    ...
    def test_watch_gradient_true(self):
        ...
        with patch("poutyne.framework.wandb_logger.wandb") as wandb_patch:
            ...
            self.run_mock.watch.assert_called_once() # once_with

    def test_get_logs_without_unknown_keys(self):
        ...
        with patch("poutyne.framework.wandb_logger.wandb") as wandb_patch:
            ...
            cleaned_dict = logger._get_logs_without_unknown_keys(self.uncleaned_log)

            self.assertRaises(KeyError, lambda: cleaned_dict["size"])
